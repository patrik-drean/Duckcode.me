"""
Django settings for coding_duck project.
...
SECRET_KEY = 'ly2us8xcvb%whg!hyzs*r28jplo^kx@^s4eo9k^kfbm*@_(fir'
...
WSGI_APPLICATION = 'coding_duck.wsgi.application'
